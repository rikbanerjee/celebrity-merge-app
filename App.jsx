            ...
            parts: [
              {
                ...
                text: `Generate a single, high-quality photorealistic image featuring both people from the provided inputs. The two subjects must be standing side-by-side, at a consistent full-body scale, and their faces and expressions should be an accurate representation of the original images. Combine them seamlessly in a ${backgroundPrompt || 'glamorous red carpet'}. The image should be fun and vibrant, like a high-fashion photo shoot. Negative prompt: morphed faces, blended features, distorted features, altered likeness, hybrid faces, cartoon, painting, sketch, asymmetrical eyes, blurry facial features, unnatural expressions, inconsistent scale, incorrect perspective, distorted anatomy, different distances, cropped subjects.`
              },
              {
                inlineData: {
                  mimeType: "image/png",
